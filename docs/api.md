...
```js
const { project } = require('@aikdna/kdna-studio-core');
...
```js
const { cards } = require('@aikdna/kdna-studio-core');
...
```js
const { compile } = require('@aikdna/kdna-studio-core');
...
```js
const { quality } = require('@aikdna/kdna-studio-core');
...
```js
const { provenance } = require('@aikdna/kdna-studio-core');
...
```js
const { governance } = require('@aikdna/kdna-studio-core');
...
```js
const { feynman } = require('@aikdna/kdna-studio-core');
...
```js
const { contradiction } = require('@aikdna/kdna-studio-core');
...
```js
const { validateCards } = require('@aikdna/kdna-studio-core');
...
```js
const { evidence } = require('@aikdna/kdna-studio-core');
...
```js
const { testlab } = require('@aikdna/kdna-studio-core');
...
```js
const { delta } = require('@aikdna/kdna-studio-core');
...
```js
const { versioning } = require('@aikdna/kdna-studio-core');
...
| @aikdna/kdna-studio-core | @aikdna/kdna-core | @aikdna/kdna-cli | KDNA SPEC |
|:-------------------:|:-----------------:|:----------------:|:---------:|
